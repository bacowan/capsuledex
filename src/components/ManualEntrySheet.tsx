  ...
  return (
    <div className="fixed inset-x-0 bottom-0 bg-surface rounded-t-2xl border-t border-edge overflow-hidden md:inset-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:rounded-2xl md:w-[360px] md:border md:border-edge">
      ...
      <div className="px-4 pb-5 pt-1 flex flex-col gap-3">
        <p className="text-[13px] font-medium text-fg">Enter barcode number</p>

        {/* Input — default state */}
        <div className="flex items-center border border-edge rounded-xl overflow-hidden bg-surface h-[42px]">
        ...
        {/* TODO: handle lookup */}
        <button className="w-full py-3 bg-brand text-white text-sm font-medium rounded-xl hover:bg-brand-hover transition-colors">
          Look up
        </button>
      </div>
